...
app.MapReverseProxy(); //middleware'i ekliyoruz

app.Run();

static IReadOnlyList<RouteConfig> ConfigureRoutes()
{
...
static IReadOnlyList<ClusterConfig> ConfigureClusters()
{
    return new List<ClusterConfig>
    {
        new ClusterConfig
        {
            ...
            {
                { "destination1", new DestinationConfig { Address = "https://localhost:7291" } }
            }
        },
        new ClusterConfig
        {
            ...
            Destinations = new Dictionary<string, DestinationConfig>
            {
                { "destination1", new DestinationConfig { Address = "https://localhost:7125" } }
            }
        },
        new ClusterConfig
        {
            ...
            Destinations = new Dictionary<string, DestinationConfig>
            {
                { "destination1", new DestinationConfig { Address = "https://localhost:7062" } }
            }
        }
    };
}